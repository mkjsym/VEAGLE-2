...
def initialize_tree(input_ids, model, pixel_values, past_key_values, logits_processor, token_process, num_img_tokens):
    ...
    draft_tokens, retrieve_indices,tree_mask,tree_position_ids, attentions = model.ea_layer.topK_genrate(filtered_hidden_states, filtered_input_ids, model.base_model.language_model.lm_head,logits_processor,filtered_image_features)
...
def update_inference_inputs(
    ...
    return input_ids, draft_tokens, retrieve_indices,tree_mask,tree_position_ids, new_token, None, token, tgt_tokens,dft_tokens, attentions
